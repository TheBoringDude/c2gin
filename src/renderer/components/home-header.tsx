  ...
  return (
    <>
      <div className="mb-2 w-5/6">
        <h1 className="text-2xl font-black tracking-wide text-indigo-500 dark:text-indigo-400 truncate">
          c2gin
        </h1>
        <p className="tracking-wide font-light mt-1 truncate dark:text-white">
          {/* TODO:
